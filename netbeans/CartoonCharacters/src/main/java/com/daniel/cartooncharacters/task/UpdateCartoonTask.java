 ...
 * in a background thread to update cartoon information.
 * 
 * @author Bryan Daniel
 */
public class UpdateCartoonTask extends Task<Void> {
     ...
     */
    public UpdateCartoonTask(String cartoonName, String cartoonDescription) {
    ...
    protected Void call() throws Exception {
        ...
        if (cartoon != null) {
            ...
            successful = dataAccess.updateCartoon(cartoon);
        } else {
            successful = false;            
        }
        return null;
    ...
    protected void succeeded() {
        Label label;
        if (successful) {
            label = new Label("Cartoon updated successfully.");
        } else {
            label = new Label("The cartoon does not exist.");
        }
